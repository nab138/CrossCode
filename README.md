...
- The code to sign and install apps onto a device has been removed from YCode's source and moved to a standalone package, [isideload](https://github.com/nab138/isideload). It was built on a lot of other libraries, so check out it's README for more info.
